 <?php
        ...
        $layout = (isset($_GET['car_layout']) && $_GET['car_layout'] == 'layout2') ? $_GET['car_layout'] : 'layout1';
		?>
       <div class="map-container">
            <div class="jws-car-google-map" data-map_options="{&quot;zoom&quot;:16,&quot;mapTypeId&quot;:&quot;roadmap&quot;,&quot;mapTypeControl&quot;:true,&quot;streetViewControl&quot;:false,&quot;zoomControl&quot;:true,&quot;fullscreenControl&quot;:true,&quot;gestureHandling&quot;:true}" data-cluster="no" data-max-width="250" data-locations="[[<?php echo ''.$lat; ?>,<?php echo ''.$longu; ?>,true,&quot;<?php echo ''.$address; ?>&quot;,&quot;&quot;,&quot;html&quot;,&quot;&quot;,&quot;&quot;,&quot;&quot;]]" data-animate="" data-auto-center="center" data-predefined-style="standard"></div>
       
        <script type="text/javascript">
        jQuery(document).ready(function ($) {
        var WidgetjwsGoogleMapHandler = function ( ) {


		var selector                = $( '.jws-car-google-map' ),
            ...
            className = '<?php echo ''.$layout == 'layout2' ? esc_attr('map_pin_jws this') : esc_attr('map_pin_jws'); ?>';
		...
		( function initMap () {
			...
			var map = new google.maps.Map( $('.jws-car-google-map' )[0], map_options );
