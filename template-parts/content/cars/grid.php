<?php 
    ...
    if(!empty($car_images)) {
        ...
        $img_car_hover = (isset($car_images[1])) ? jws_getImageBySize(array('attach_id' => $car_images[1], 'thumb_size' => 'jws-car-size', 'class' => 'car-images-hover')) : '';
    }
?>
    ...
    <div class="car-content">
        <div class="car-content-top">
            ...
            <div class="car-content-top-left">
                ...
                <?php $long =   get_post_meta( get_the_ID() , 'vehicle_location',  true ); ?>
                <div class="car-location" title="<?php echo ''.$long['address']; ?>">
                  <?php 
                        if(!empty($long)) {
                            echo '<i class="fas fa-map-marker-alt"></i>'.limitTextWords($long['address'], 3, true, true).''; 
